            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="site-heading">
                        <h1>Register</h1>
                        <hr class="small">
                        <span class="subheading">Wanna be a author? Register yourself</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row control-group">
            <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }} form-group col-xs-12 floating-label-form-group controls">
              <label for="username">Username</label>
                  ...
                  <input id="username" placeholder="Pick an Username " type="text" class="form-control" name="username" value="{{ old('username') }}">
