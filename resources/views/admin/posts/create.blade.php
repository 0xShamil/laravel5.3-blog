				...
				<div class="col-md-12">
					<div class="box box-info">
						...
						<div class="box-body pad">
							<form method="post" action="{{ route('admin.posts.store') }}" class="form-horizontal" enctype="multipart/form-data">
								{{ csrf_field() }}
								...
								<div class="form-group">
									...
									<div class="col-sm-11">
										<input class="form-control" name="teaser" id="description" placeholder="description">
									</div>
								</div>
