					...
					<div>
						<div class="box-body">
							...
							<div class="form-group">
								...
								<input class="form-control" name="facebook" placeholder="Facebook profile" value="{{ $user->facebook }}" disabled="true">
							</div>
							<div class="form-group">
								<label for="Email">Twitter:</label>
								<input class="form-control" name="twitter" placeholder="Twitter Profile" value="{{ $user->twitter }}" disabled="true">
							</div>
							<div class="form-group">
								<label for="Email">LinkedIn:</label>
								<input class="form-control" name="linkedin" placeholder="LinkedIn Profile" value="{{ $user->linkedin }}" disabled="true">
							</div>
							<div class="form-group">
